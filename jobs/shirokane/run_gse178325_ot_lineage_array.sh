...
#$ -cwd
#$ -j y
#$ -o logs/run_gse178325_ot_lineage.$JOB_ID.$TASK_ID.log
#$ -l s_vmem=192G
#$ -t 1-2
...
if [ "${SCENARIO}" != "A" ]; then
  echo "ERROR: this array is only for GSE178325 scenario A, got ${SCENARIO}" >&2
  exit 3
fi
...
print(
    "[OK] GSE178325 OT lineage completed: "
...
echo "============================================================"
echo "GSE178325 OT lineage run finished at: $(date)"
echo "Config: ${CONFIG}"
echo "============================================================"
