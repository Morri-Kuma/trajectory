...
run_marker_fm_transition_silver_embedding_coherence_array.sh
run_marker_fm_reference_ari_embedding_array.sh
run_marker_fm_reference_ari_embedding_sensitivity_array.sh
submit_marker_fm_transition_silver_embedding_coherence.sh
submit_marker_fm_reference_ari_embedding.sh
submit_marker_fm_reference_ari_embedding_with_sensitivity.sh
```
...
chmod +x submit_marker_fm_transition_silver_embedding_coherence.sh
chmod +x run_marker_fm_transition_silver_embedding_backfill_array.sh
chmod +x run_marker_fm_transition_silver_embedding_coherence_array.sh
bash submit_marker_fm_transition_silver_embedding_coherence.sh
```
...
```bash
RUN_BACKFILL=0 bash submit_marker_fm_transition_silver_embedding_coherence.sh
```
...
```bash
cd /home/xzy0723/projects/trajectory
chmod +x submit_marker_fm_reference_ari_embedding.sh
chmod +x run_marker_fm_reference_ari_embedding_array.sh
bash submit_marker_fm_reference_ari_embedding.sh
```
...
```bash
cd /home/xzy0723/projects/trajectory
chmod +x submit_marker_fm_reference_ari_embedding_with_sensitivity.sh
chmod +x run_marker_fm_reference_ari_embedding_array.sh
chmod +x run_marker_fm_reference_ari_embedding_sensitivity_array.sh
bash submit_marker_fm_reference_ari_embedding_with_sensitivity.sh
```
