...
#$ -cwd
#$ -j y
#$ -o logs/run_scfm_scgpt_build_xrep.$JOB_ID.$TASK_ID.log
#$ -l s_vmem=96G
#$ -t 1-3
...
INPUT_H5AD="${INPUT_H5AD:-benchmark/inputs/representation/gse230659/source/GSE230659_scgpt_cls_full_gene.h5ad}"
REPRESENTATION_ID="${REPRESENTATION_ID:-rep_scgpt_cls_pca50}"
...
echo "============================================================"
echo "Build scGPT X_rep started at: $(date)"
...
echo "============================================================"
echo "Build scGPT X_rep finished at: $(date)"
echo "Scenario: ${SCENARIO}"
echo "Output h5ad: ${OUTPUT_H5AD}"
echo "============================================================"
