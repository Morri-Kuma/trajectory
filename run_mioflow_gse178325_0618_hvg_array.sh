...
#$ -cwd
#$ -j y
#$ -o logs/run_mioflow_gse178325_0618_hvg.$JOB_ID.$TASK_ID.log
#$ -l s_vmem=128G
#$ -t 1-3
...
case "${SGE_TASK_ID:-${TASK_ID:-1}}" in
  1)
    SCENARIO="A"
    CONFIG="benchmark/configs/mioflow_gse178325_observed_0618_hvg2000_A_scgpt_v1.yaml"
    OUTPUT_DIR="benchmark/results/mioflow/gse178325_0618_scenario_A_hvg2000"
    ;;
  2)
    SCENARIO="B"
    CONFIG="benchmark/configs/mioflow_gse178325_observed_0618_hvg2000_B_scgpt_v1.yaml"
    OUTPUT_DIR="benchmark/results/mioflow/gse178325_0618_scenario_B_hvg2000"
    ;;
  3)
    SCENARIO="C"
    CONFIG="benchmark/configs/mioflow_gse178325_observed_0618_hvg2000_C_scgpt_v1.yaml"
    OUTPUT_DIR="benchmark/results/mioflow/gse178325_0618_scenario_C_hvg2000"
    ;;
  *)
