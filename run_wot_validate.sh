...
#$ -cwd
#$ -j y
#$ -o logs/run_wot_validate.$JOB_ID.log
#$ -l s_vmem=32G
...
CONFIG="benchmark/configs/wot_gse230659_observed_scgpt_v1.yaml"
OUTPUT_DIR="benchmark/results/wot/scenario_A_scgpt_v1_shirokane_test"
