...
#$ -cwd
#$ -j y
#$ -o logs/run_prescient_cpu_A_hvg.$JOB_ID.log
#$ -l s_vmem=48G
...
BASE_CONFIG="benchmark/configs/prescient_gse230659_observed_scgpt_v1_A_hvg2000_formal.yaml"
CPU_CONFIG="benchmark/configs/prescient_gse230659_observed_scgpt_v1_A_hvg2000_cpu.yaml"
ADATA="benchmark/inputs/gse230659_scgpt_hvg2000/GSE230659_scGPT_annotated_HVG2000_benchmark_input.h5ad"
OUTPUT_DIR="benchmark/results/prescient/scenario_A_scgpt_v1_hvg2000_cpu"
...
echo "Scenario      : A HVG2000 CPU low-memory"
...
cfg["run_id"] = "prescient_gse230659_A_scgpt_v1_hvg2000_cpu"
cfg["result_class"] = "reduced_validation"
cfg["formal_benchmark"] = False
cfg["scenario_name"] = "Observed-time PRESCIENT CPU low-memory run (HVG2000, scGPT-v1)"
