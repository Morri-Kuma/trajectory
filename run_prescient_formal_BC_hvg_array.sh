...
#$ -cwd
#$ -j y
#$ -o logs/run_prescient_formal_BC_hvg.$JOB_ID.$TASK_ID.log
#$ -l s_vmem=128G
#$ -t 1-2
...
case "${SGE_TASK_ID:-${TASK_ID:-1}}" in
  1)
    SCENARIO="B"
    CONFIG="benchmark/configs/prescient_gse230659_observed_scgpt_v1_scenarioB_hvg2000_formal.yaml"
    OUTPUT_DIR="benchmark/results/prescient/scenario_B_scgpt_v1_hvg2000_formal"
    ;;
  2)
    SCENARIO="C"
    CONFIG="benchmark/configs/prescient_gse230659_observed_scgpt_v1_scenarioC_hvg2000_formal.yaml"
    OUTPUT_DIR="benchmark/results/prescient/scenario_C_scgpt_v1_hvg2000_formal"
    ;;
  *)
