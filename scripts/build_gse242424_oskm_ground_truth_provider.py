...
(author-cluster-matched ground truth subset).

Provider ID : gse242424_oskm_reprogramming_ground_truth_v1
...
Run from the repository root:
    python scripts/build_gse242424_oskm_ground_truth_provider.py
...
PROVIDER_ID = "gse242424_oskm_reprogramming_ground_truth_v1"
DATASET_ID = "GSE242424"
LABEL_MODE = "ground_truth"
LABEL_TYPE = "frozen_ground_truth"
...
GENERATED_BY = "scripts/build_gse242424_oskm_ground_truth_provider.py"
...
def build_reference_graph_json() -> dict:
    ...
    meta = {
        ...
        "n_edges": len(EDGES),
        "policy": [
            "Official frozen ground truth coarse milestone reference graph for GSE242424 OSKM reprogramming.",
...
def write_ground_truth_metadata_json(out_dir: Path, counts: dict[str, int]) -> None:
    ...
    meta = {
        ...
        "label_mode": LABEL_MODE,
        "label_type": LABEL_TYPE,
        "annotation_method": "author_cluster_oskm_reprogramming_ground_truth_provider",
        "status": "frozen_ground_truth_milestone_provider",
        "state_key": STATE_KEY,
