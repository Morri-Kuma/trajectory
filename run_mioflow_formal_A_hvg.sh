...
#$ -cwd
#$ -j y
#$ -o logs/run_mioflow_formal_A_hvg.$JOB_ID.log
#$ -l s_vmem=128G
...
CONFIG="benchmark/configs/mioflow_gse230659_observed_scgpt_v1_A_hvg2000_formal.yaml"
ADATA="benchmark/inputs/gse230659_scgpt_hvg2000/GSE230659_scGPT_annotated_HVG2000_benchmark_input.h5ad"
OUTPUT_DIR="benchmark/results/mioflow/scenario_A_scgpt_v1_hvg2000_formal"
