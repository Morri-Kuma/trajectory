# GSE242424 OSKM Reprogramming Silver Benchmark Report

**Generated:** 2026-05-16  
**Provider:** `gse242424_oskm_reprogramming_silver_v1`  
**Label mode:** `official_silver`  
**State key:** `final_milestone_label_coarse`  
**Result class:** `gse242424_oskm_silver_formal`
...
The silver labels come from the frozen provider built from author ATAC-to-RNA cluster transfer annotations and the matched local scRNA-seq cells.
...
2. The silver provider is based on author cluster transfer labels, not on an independently validated lineage tree.
...
| File | Description |
| --- | --- |
| `gse242424_oskm_silver_core_metrics.csv` | Per-run metric table for the 9 formal runs |
| `gse242424_oskm_silver_rankings.csv` | Within-scenario ranks and composite scores |
| `gse242424_oskm_silver_method_summary.csv` | Per-method means and overall rank |
| `gse242424_oskm_silver_report.md` | This report |

Reference graph: `benchmark/ground_truth/providers/gse242424_oskm_reprogramming_silver_v1/reference_graph.json`  
Provider registry entry: `benchmark/ground_truth/registry.yaml` -> `gse242424_oskm_reprogramming_silver_v1`
