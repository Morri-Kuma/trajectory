"""
eval_embedding_generative_inactive.py
Embedding Coherence evaluator for FUTURE generative/forecasting models — INACTIVE.

NOTE: This is NOT the evaluator behind the reported embedding numbers. The official
embedding-coherence metrics in this paper are produced by eval_embedding_milestone.py
(written to embedding_milestone_eval/embedding_metrics_official_silver.json). This
module stays inactive until generative models that project unseen-timepoint cells
are added; it was renamed from eval_embedding.py to remove that naming collision.
Framework reference: docs/framework/experimental_framework_v2.md §8, §14 Step 4
