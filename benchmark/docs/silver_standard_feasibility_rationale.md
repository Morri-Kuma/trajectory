...
项目证据：`experimental framework v2.md` 记录了 2026-05-11 的修正；`benchmark/reports/official_silver/official_silver_model_rankings.md` 说明 embedding coherence 使用 `leiden_from_projected_embedding:projected_embedding.npy:n_neighbors=15:resolution=1.0`。
