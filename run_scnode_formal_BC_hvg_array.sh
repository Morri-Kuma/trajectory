...
#$ -cwd
#$ -j y
#$ -o logs/run_scnode_formal_BC_hvg.$JOB_ID.$TASK_ID.log
#$ -l s_vmem=128G
#$ -t 1-2
...
case "${SGE_TASK_ID:-${TASK_ID:-1}}" in
  1)
    ...
    RUN_ID="scnode_gse230659_B_scgpt_v1_hvg2000_formal"
    FORMAL_CONFIG="benchmark/configs/scnode_gse230659_observed_scgpt_v1_scenarioB_hvg2000_formal.yaml"
    OUTPUT_DIR="benchmark/results/scnode/scenario_B_scgpt_v1_hvg2000_formal"
    ;;
  2)
    SCENARIO="C"
    BASE_CONFIG="benchmark/configs/scnode_gse230659_observed_scgpt_v1_scenarioC.yaml"
    RUN_ID="scnode_gse230659_C_scgpt_v1_hvg2000_formal"
    FORMAL_CONFIG="benchmark/configs/scnode_gse230659_observed_scgpt_v1_scenarioC_hvg2000_formal.yaml"
    OUTPUT_DIR="benchmark/results/scnode/scenario_C_scgpt_v1_hvg2000_formal"
    ;;
  *)
...
echo "------------------------------------------------------------"
echo "Preparing Scenario ${SCENARIO} formal config"
echo "------------------------------------------------------------"
...
cfg["scenario_name"] = f"Scenario ${SCENARIO} formal scNODE run (HVG2000, scGPT-v1)"
